...
IL2CPP_EXTERN_C String_t* _stringLiteralF6E8E032950DCB5DCF04112ADD6DFE8032FE2972;
...
IL_0042:
	{
		...
		float L_13 = __this->___enemySpeed_5;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_14;
		L_14 = Vector3_MoveTowards_m3E2E4E94093F49D09DEB34CA97BF8A632B27F1AD_inline(L_10, L_11, ((float)il2cpp_codegen_multiply(L_12, L_13)), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void EnemyHealth_OnCollisionEnter_m4006F48F80111D33FDB9C59ADA6556B2792863DC (EnemyHealth_t2937DFCC8299F967896C0B08F9D3E3F2816AA53D* __this, Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* ___collision0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___currentHealth_9 = ((int32_t)il2cpp_codegen_subtract(L_3, ((int32_t)10)));
	}

IL_0021:
	{
		// healthSlider.value = currentHealth;
		Slider_t87EA570E3D6556CABF57456C2F3873FFD86E652F* L_4 = __this->___healthSlider_5;
		int32_t L_5 = __this->___currentHealth_9;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LevelManager_Win_m1B7E455357CBCCD8D5450A718F0CAA65F9072E33 (LevelManager_t8405886BBC5A0ACBB1CC210E25D5DA1C72D16530* __this, const RuntimeMethod* method) 
{
	...
	{
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral0FBF94C5E695F3A34108CEA8371F76B633243DD3);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralF6E8E032950DCB5DCF04112ADD6DFE8032FE2972);
		s_Il2CppMethodInitialized = true;
	}
	{
		...
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_4 = __this->___gameText_8;
		VirtualActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_4, _stringLiteralF6E8E032950DCB5DCF04112ADD6DFE8032FE2972);
		// gameText.gameObject.SetActive(true);
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_5 = __this->___gameText_8;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_6;
		L_6 = Component_get_gameObject_m57AEFBB14DB39EC476F740BA000E170355DE691B(L_5, NULL);
		...
		MonoBehaviour_Invoke_mF724350C59362B0F1BFE26383209A274A29A63FB(__this, _stringLiteral0FBF94C5E695F3A34108CEA8371F76B633243DD3, (5.0f), NULL);
		// }
		return;
	}
}
...
IL_0036:
	{
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_14 = __this->___controller_8;
		bool L_15;
	...
	{
		// if (!grounded)
		bool L_16 = __this->___grounded_11;
		if (L_16)
		{
			goto IL_00ab;
		}
...
IL_00ab:
	{
		// moveDirection = input;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_22 = __this->___input_9;
		__this->___moveDirection_10 = L_22;
		// if (Input.GetButton("Jump"))
		bool L_23;
		L_23 = Input_GetButton_mD0363B5F1771A7C7A97ABB0D07863217D229A9C0(_stringLiteral70253F929BCE7F81DF1A5A1C0900BED744E86C9C, NULL);
		if (!L_23)
		{
			goto IL_0109;
		}
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_24 = (&__this->___moveDirection_10);
		float L_25 = __this->___jumpHeight_5;
		float L_26 = __this->___gravity_6;
		float L_27;
...
IL_0109:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_33 = (&__this->___moveDirection_10);
		L_33->___y_3 = (0.0f);
	}
...
IL_0119:
	{
		// if (walking)
		bool L_34 = __this->___walking_12;
		if (!L_34)
		{
			goto IL_0149;
		}
	}
	{
		...
		AudioSource_set_volume_mD902BBDBBDE0E3C148609BF3C05096148E90F2C0(L_39, (1.0f), NULL);
		goto IL_01b1;
	}
...
IL_0149:
	{
		...
		L_44 = GameObject_GetComponent_TisAudioSource_t871AC2272F896738252F04EE949AEF5B241D3299_m4F30DAB8E5B57E8DB6BD8C0C3BB11CCB57690C4A(L_43, GameObject_GetComponent_TisAudioSource_t871AC2272F896738252F04EE949AEF5B241D3299_m4F30DAB8E5B57E8DB6BD8C0C3BB11CCB57690C4A_RuntimeMethod_var);
		AudioSource_set_volume_mD902BBDBBDE0E3C148609BF3C05096148E90F2C0(L_44, (0.0f), NULL);
		goto IL_01b1;
	}
...
IL_0171:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_45 = (&__this->___input_9);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_46 = (&__this->___moveDirection_10);
		float L_47 = L_46->___y_3;
		L_45->___y_3 = L_47;
		// moveDirection = Vector3.Lerp(moveDirection, input, airControl * Time.deltaTime);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_48 = __this->___moveDirection_10;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_49 = __this->___input_9;
		float L_50 = __this->___airControl_7;
		float L_51;
		...
		__this->___moveDirection_10 = L_52;
	}

IL_01b1:
	{
		// moveDirection.y -= gravity * Time.deltaTime;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_53 = (&__this->___moveDirection_10);
		float* L_54 = (&L_53->___y_3);
		float* L_55 = L_54;
		float L_56 = *((float*)L_55);
		float L_57 = __this->___gravity_6;
		float L_58;
		L_58 = Time_get_deltaTime_m7AB6BFA101D83E1D8F2EF3D5A128AEE9DDBF1A6D(NULL);
		*((float*)L_55) = (float)((float)il2cpp_codegen_subtract(L_56, ((float)il2cpp_codegen_multiply(L_57, L_58))));
		// controller.Move(moveDirection * speed * Time.deltaTime);
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_59 = __this->___controller_8;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_60 = __this->___moveDirection_10;
		...
		int32_t L_65;
		L_65 = CharacterController_Move_mE3F7AC1B4A2D6955980811C088B68ED3A31D2DA4(L_59, L_64, NULL);
		// }
		return;
	}
}
